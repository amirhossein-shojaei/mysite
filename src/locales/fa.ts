const content: Record<string, string> = {
  ...
  DevOps: "دوآپس",
  "Machine Learning / Data": "یادگیری ماشین / داده",
  "AI Tools & Ecosystem": "ابزارها و اکوسیستم هوش مصنوعی",
  "Other Technologies": "تکنولوژی‌های دیگر",
  ...
  "Messaging & Event Streaming": "پیام‌رسانی و جریان رویداد",
  "Advanced Database": "پایگاه داده پیشرفته",
  "CI/CD & DevOps": "CI/CD و دوآپس",
  Security: "امنیت",
  "Performance Engineering": "مهندسی عملکرد",
  "Software Engineering": "مهندسی نرم‌افزار",
  "Linux & Server Administration": "لینوکس و مدیریت سرور",
  "API & Integration": "API و یکپارچه‌سازی",
  ...
  "WHAT I BUILD": "چیزهایی که می‌سازم",
  "The layers behind a product.": "لایه‌های یک محصول کامل.",
  "HOW I WORK": "روش کار من",
  "NEXT STEP": "قدم بعدی",
...
export const fa = {
  ...
  home: {
    ...
    build: "۵ / چیزهایی که می‌سازم",
    buildTitle: "لایه‌های یک محصول کامل.",
    process: "۶ / روش کار من",
    next: "۷ / قدم بعدی",
