...
export const projects: Project[] = [
  {
    ...
    technologies: ["AI integration", "PWA", "Web application"],
    projectUrl: "https://myelixia.com/",
    featured: true,
    status: "Completed",
    client: "Elixia",
    problem: "Fitness and nutrition planning can be difficult to personalize.",
    solution:
  ...
  },
  {
    ...
    technologies: ["AI integration", "Data systems", "Web application"],
    ...
    contribution: later,
    features: [
      "Inventory/product code transformation",
  ...
  },
  {
    ...
    technologies: ["PWA", "Responsive design", "Web application"],
  ...
  },
  {
    ...
    technologies: ["PWA", "AI chatbot", "Web application"],
    ...
    features: [
      ...
      "News",
      "Exhibitor and company information",
      "AI chatbot",
    ],
