    ...
    <section className="page container detail">
      ...
      <div className="detail-head">
        ...
        <div className="detail-links">
          ...
          {p.organizationUrl && (
            <ArrowLink href={p.organizationUrl}>
              {t("Official Website")}
            </ArrowLink>
          )}
        </div>
      ...
      <div className="detail-grid">
        {blocks.map(([h, v]) => (
          <div className="detail-block" key={h}>
        ...
        <div className="detail-block">
          ...
          <ul>
            {p.features.length ? (
              ...
              <li>{t("Details will be added later.")}</li>
            )}
          </ul>
        </div>
        <div className="detail-block">
          <p className="eyebrow">{t("Technology Stack")}</p>
          <div className="tags">
            {p.technologies.length ? (
              p.technologies.map((x) => <span key={x}>{t(x)}</span>)
            ) : (
              <span>{t("Details will be added later.")}</span>
            )}
          </div>
        </div>
      </div>
